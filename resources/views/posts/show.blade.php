    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section id="comments" class="bg-white rounded-lg shadow-md p-8">
            ...
            <div class="space-y-6">
                @forelse ($post->comments as $comment)
                    <div class="flex gap-4">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full flex items-center justify-center text-white font-semibold">
                ...
                @empty
                    <p class="text-gray-600">Brak komentarzy. Bądź pierwszą osobą, która skomentuje ten post.</p>
                @endforelse
            </div>
        </section>
